...
def parse_args():
    ...
    parser.add_argument("--loss_fn", type="str", default="l2", help="Loss function to train the phi network (l1, or l2)")
    ...
    parser.add_argument("--enable_validation", action="store_true", default=False, help="Whether to use enable validation.")
...
def train_phi(args):
    ...
    ## evaluator
    if accelerator.is_main_process and args.enable_validation:
    ...
    while True:
        for idx, (original_tokens, replaced_tokens, indicators) in enumerate(train_dataset):
            ...
            if args.loss_fn == "l2":
                ...
                loss = F.l1_loss(replaced_text_embeddings.float(), original_text_embeddings.float(), reduction="mean")
            ...
            if accelerator.sync_gradients:
                ...
                if (global_step % args.validation_steps == 0 or global_step == 50) and args.enable_validation:
                    if accelerator.is_main_process:
